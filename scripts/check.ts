...
const contractAddress = "0xa1BBFFAdFcd474372186E1f232a5cC3A71Aef7f6"; 
const TokenABI = [
    {
      "inputs": [
        {
    ...
    },
    {
      ...
      "name": "withdrawSpecificReflectionToken",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
...
async function calcularTransaccionTotal() {
    let contractTokenBalance;
    let swapThreshold;
    
    do {
        contractTokenBalance = await tokenContract.balanceOf(contractAddress);
        console.log(contractTokenBalance.toString());
        swapThreshold = await tokenContract.swapTokensAtAmount();
        console.log(swapThreshold.toString());
        await new Promise(resolve => setTimeout(resolve, 5000)); // Espera 5 segundos
    } while (contractTokenBalance < swapThreshold);
    
}

calcularTransaccionTotal();
